...
A utility that provide a way to manage single (or global) loading state via multiple Hooks or simple JS/TS functions, use [Reactive](https://sheinsight.github.io/reactive/) under the hood.
