...
`UseThrottledFnOptions` 是 `useThrottledFn` 的选项，参见 <Link to="/reference/use-throttled-fn/#options">useThrottledFn</Link>。

`UseDebouncedFnOptions` 是 `useDebouncedFn` 的选项，参见 <Link to="/reference/use-debounced-fn/#options">useDebouncedFn</Link>。
