...
import type { UseManualStateHistoryOptions, UseManualStateHistoryReturn } from '../use-manual-state-history'
...
export interface UseStateHistoryReturn<Raw, Serialized>
  extends UseManualStateHistoryReturn<Raw, Serialized>,
